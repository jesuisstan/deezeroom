      ...
      <View className="gap-2">
        ...
        <View className="ml-11">
          <View className="flex-row items-start gap-3">
            <View className="mt-2 h-2 w-2 rounded-full bg-text-secondary" />
          ...
          <View className="flex-row items-start gap-3">
            <View className="mt-2 h-2 w-2 rounded-full bg-text-secondary" />
            <TextCustom color={themeColors[theme]['text-secondary']}>
              Tracks are appearing in your Favorites that weren't favorited by
              you
            </TextCustom>
          </View>
          <View className="flex-row items-start gap-3">
            <View className="mt-2 h-2 w-2 rounded-full bg-text-secondary" />
            <TextCustom color={themeColors[theme]['text-secondary']}>
              You are unable to log into your account due to an unauthorized
              password change
            </TextCustom>
          </View>
        </View>
      ...
      <View className="gap-2">
        ...
        <View className="ml-11">
          ...
          <View className="flex-row items-start gap-3">
            <View className="mt-2 h-2 w-2 rounded-full bg-text-secondary" />
            <TextCustom color={themeColors[theme]['text-secondary']}>
              If you suspect that your email address may have been compromised,
              you can change the email linked to your Deezer account in your
              settings
            </TextCustom>
          </View>
        </View>
